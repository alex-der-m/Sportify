...
namespace Sportify_Back.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Dni,Mail,Phone,Address,Active")] Teachers teachers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Dni,Mail,Phone,Address,Active")] Teachers teachers)
        {
            if (id != teachers.Id)
            {
                return NotFound();
